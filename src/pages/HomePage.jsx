...
const HomePage = () => {
  ...
  const slides = [
    {
      bg: 'https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
      title: 'Unleash Effortless Style',
      subtitle: 'Ultra-soft, trend-forward tees designed to elevate your everyday vibe.',
      cta: 'Explore the Collection'
    },
    {
      bg: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
      title: 'Fresh Drops Weekly',
      subtitle: "Stay ahead of the curve with new arrivals you won't find anywhere else.",
      cta: "Browse What's New"
    },
    {
      bg: 'https://images.unsplash.com/photo-1527719327859-c6ce80353573?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
      title: 'Stand Out. Limited Run.',
      subtitle: 'Bold designs. Rare prints. Crafted for those who dare to be different.',
      cta: 'Claim Your Look'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "The quality of these tees is unmatched! I've washed them dozens of times and they still look brand new. My go-to for everyday comfort and style.",
      rating: 5
    },
    {
      id: 2,
      ...
      content: 'Finally found a brand that gets the fit just right. The oversized collection is perfect - not too baggy but still super comfortable.',
      rating: 4
    },
    {
      id: 3,
      name: 'Emma L.',
      role: 'Stylist',
      content: 'My clients love how versatile these pieces are. The neutral colors pair perfectly with everything in their wardrobes.',
      rating: 5
    }
  ];
  ...
  const benefits = [
    {
      icon: '🚚',
      title: 'Fast Shipping',
      description: 'Get your order in 2-3 business days with our express delivery'
    },
    {
      icon: '♻️',
      title: 'Eco-Friendly',
    ...
    },
    {
      ...
      description: 'Durable fabrics that maintain their shape and color wash after wash'
    }
  ];
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section className="relative overflow-hidden py-30 px-4">
        {/* Background carousel */}
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 text-center">
      {[
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-3 p-5 rounded-lg border hover:shadow-md transition cursor-pointer bg-gray-50"
        >
          <img 
            src={cat.image} 
            alt={cat.name} 
      ...
      <motion.section 
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="bg-gradient-to-r from-[#09122C] to-[#2A004E] py-14 px-4 text-white"
      >
